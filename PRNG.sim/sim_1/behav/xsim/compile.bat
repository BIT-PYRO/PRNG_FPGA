...
REM
REM Generated by Vivado on Wed Nov 19 15:53:58 +0530 2025
...
echo "xvlog --incr --relax -prj prng_top_vlog.prj"
call xvlog  --incr --relax -prj prng_top_vlog.prj -log xvlog.log
