...
set_property -dict { PACKAGE_PIN H17 IOSTANDARD LVCMOS33 } [get_ports { led_heartbeat }]; #IO_L18P_T2_A24_15 Sch=led[0]
#set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { led_byte }]; #IO_L24P_T3_RS1_15 Sch=led[1]
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 PULLDOWN true } [get_ports { btn_entropy }]; #IO_L9P_T1_DQS_14 Sch=btnc
